...
class TestBook:
    ...
    def test_construction_modification(self):
        book = Book(84765876, "Harry Potter", "url", "some url")
    ...
    def test_invalid_title(self):
        with pytest.raises(ValueError):
            book = Book(84765876, "","url", "some url")
        with pytest.raises(ValueError):
            book = Book(84765876, Publisher("DC Comics"),"url", "some url")

    def test_invalid_book_ids(self):
        book = Book(0, "Harry Potter","url", "some url")
        assert str(book) == "<Book Harry Potter, book id = 0>"

        with pytest.raises(ValueError):
            book = Book(-1, "Harry Potter","url", "some url")

        with pytest.raises(ValueError):
            book = Book(13.786, "Harry Potter","url", "some url")

        with pytest.raises(ValueError):
            book = Book(Publisher("DC Comics"), "Harry Potter","url", "some url")

    def test_sorting(self):
        book1 = Book(874658, "Harry Potter","url", "some url")
        book2 = Book(2675376, "Hitchhiker's Guide to the Galaxy","url", "some url")
        book3 = Book(89576, "West Side Story","url", "some url")
        assert book1 < book2
        assert book1 > book3
        assert book2 > book3
    ...
    def test_comparison(self):
        book1 = Book(874658, "Harry Potter","url", "some url")
        book2 = Book(2675376, "Hitchhiker's Guide to the Galaxy","url", "some url")
        book3 = Book(89576, "Harry Potter","url", "some url")
        book4 = Book(89576, "West Side Story","url", "some url")
        assert book1 != book2
        assert book1 != book3
        assert book3 == book4

    def test_remove_author(self):
        book = Book(89576, "Harry Potter","url", "some url")

        author1 = Author(1, "J.R.R. Tolkien","url", "some url")
        author2 = Author(2, "Neil Gaiman","url", "some url")
        author3 = Author(3, "Ernest Hemingway","url", "some url")
        author4 = Author(4, "J.K. Rowling","url", "some url")
...
class TestReview:
    ...
    def test_construction(self):
        book = Book(2675376, "Harry Potter","url", "some url")
    ...
    def test_set_of_reviews(self):
        book1 = Book(2675376, "Harry Potter","url", "some url")
        book2 = Book(874658, "Lord of the Rings","url", "some url")
...
class TestUser:
    ...
    def test_reading_a_book(self):
        books = [Book(874658, "Harry Potter","url", "some url"), Book(89576, "Lord of the Rings","url", "some url")]
...
class TestBooksInventory:
    ...
    def test_construction_and_find(self):
        ...
        book1 = Book(17, "Lord of the Rings","url", "some url")
        book1.publisher = publisher1

        book2 = Book(64, "Our Memoires","url", "some url")
